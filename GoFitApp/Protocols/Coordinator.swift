...
enum CoordinatorType {
    case app, login, registration, home, details, tab, activity, history, profile, dashboard, setActiveMinutes, favouriteSports, profileDetail, sportsDetail, activityPicker, activityDetail, goalsDetail, historyDetail
}
